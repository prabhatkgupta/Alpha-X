...
def test_whatsapp():
    ...
    response = input(
        "⚠️ This will send a test message to your WhatsApp. Continue? (y/n): "
    )
    ...
    try:
        ...
        print(
            "   - For testing: Join Twilio Sandbox by sending 'join <code>' to the sandbox number"
        )
        print(
            "   - Make sure your WhatsApp number format is correct: whatsapp:+countrycode_number"
        )
        return False
